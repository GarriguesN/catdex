...
> = {
  ...
  photographer_500: { name: "Fotógrafo profesional", icon: "Aperture", rarity: "Épico", description: "Haz 500 fotos en total" },
  lucky_day: { name: "Día de suerte", icon: "Dice5", rarity: "Raro", description: "Descubre 3 gatos en un mismo día" },
  night_owl: { name: "Vigía nocturno", icon: "Moon", rarity: "Común", description: "Captura un gato entre las 22:00 y las 5:00" },
  early_bird: { name: "Madrugador", icon: "Sunrise", rarity: "Común", description: "Captura un gato entre las 5:00 y las 8:00" },
  ...
  loyal_50: { name: "Obsesionado", icon: "Repeat", rarity: "Raro", description: "Haz 50 fotos a un mismo gato" },
  rainy_day: { name: "Día de lluvia", icon: "CloudRain", rarity: "Épico", description: "Captura un gato y anota que llovía" },
